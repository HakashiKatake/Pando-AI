...
function SignUpContent() {
  ...
  useEffect(() => {
    if (isSignedIn) {
      const redirectUrl = `/user-setup?type=${userType || 'user'}`
  ...
  const handleEmailPasswordSignUp = async (e) => {
    ...
    try {
      ...
      } else if (result.unverified_fields?.includes('email_address')) {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      await signUp.authenticateWithRedirect({
        ...
        redirectUrlComplete: `/user-setup?type=${userType || 'user'}`
      })
    } catch (err) {
  ...
  const getHeaderText = () => {
    if (userType === 'organization') {
      return {
        ...
        subtitle: 'Set up your organization and manage student wellness'
      }
    ...
    return {
      ...
      subtitle: 'Start your journey to better mental wellness'
    }
  }
        ...
        >
          ...
          <div className="flex-1 relative overflow-hidden flex items-center justify-center">
            ...
            <motion.div
              ...
              style={{ backgroundColor: '#8A6FBF', top: '20%', left: '20%' }}
              animate={{
                y: [0, -20, 0],
                opacity: [0.3, 0.7, 0.3]
              }}
            ...
            <motion.div
              ...
              style={{ backgroundColor: '#6E55A0', top: '70%', left: '30%' }}
              animate={{
                y: [0, 15, 0],
                opacity: [0.4, 0.8, 0.4]
              }}
          ...
          <div className="flex-1 flex items-center justify-center px-8 py-12">
            ...
            >
              <motion.div variants={itemVariants} className="mb-8">
                <h1 className="text-3xl font-bold mb-2" style={{ color: '#6E55A0' }}>Verify Your Email</h1>
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    <Input
                      ...
                      className="h-12 border-gray-200 rounded-xl bg-white text-center text-lg tracking-widest transition-all duration-200"
      ...
      >
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12">
          ...
          >
            ...
            {/* Create Account Form */}
            <motion.form onSubmit={handleEmailPasswordSignUp} className="space-y-6" variants={itemVariants}>
              {/* Email Field */}
              ...
              <motion.div variants={itemVariants} className="text-center mt-8">
                ...
                <Link 
                  href={`/sign-in${userType ? `?type=${userType}` : ''}`} 
